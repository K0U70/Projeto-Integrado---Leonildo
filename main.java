...
public class main {
    ...
    public static void copiarLinha(String[][] origem, String[][] destino, int linhaOrigem, int linhaDestino) {
        for (int j = 0; j < origem[linhaOrigem].length; j++) {
    ...
    public static String[][] aumentarMatrizClientes(String[][] matrizAntiga) {
        ...
        for (int i = 0; i < matrizAntiga.length; i++) {
            copiarLinha(matrizAntiga, nova, i, i);
        }
        return nova;
    }
    ...
    public static String[][] apagarCliente(String[][] matrizAntiga) {
        ...
        System.out.print("Digite o código do cliente que deseja apagar: ");
        int codigo = scan.nextInt();
        scan.nextLine();

        int indice = -1;
        for (int i = 0; i < matrizAntiga.length; i++) {
            if (matrizAntiga[i][0] != null && Integer.parseInt(matrizAntiga[i][0]) == codigo) {
                indice = i;
                break;
            }
        }
        ...
        for (int i = 0; i < matrizAntiga.length; i++) {
            if (i != indice) {
                copiarLinha(matrizAntiga, nova, i, linhaNova);
                linhaNova++;
            }
        }
        ...
        for (int i = 0; i < cadastroCliente.length - 1; i++) {
            for (int j = i + 1; j < cadastroCliente.length; j++) {
                ...
                if (compararNomeCharPorChar(cadastroCliente[i][1], cadastroCliente[j][1])) {
                    ...
                    trocarLinhas(cadastroCliente, i, j);
                }
            }
        }
    }
    ...
    public static String[][] apagarContato(String[][] cadastroContato, String[][] cadastroCliente) {
        ...
        for (int i = 0; i < cadastroContato.length; i++) {
            if (i != indice) {
                copiarLinha(cadastroContato, nova, i, linhaNova);
                linhaNova++;
            }
        }
        ...
        for (int i = 0; i < cadastroCliente.length; i++) {
            ...
            for (int j = 0; j < cadastroContato.length; j++) {
                if (cadastroContato[j][0] != null &&
                        cadastroContato[j][1].equals(cadastroCliente[i][0])) {
                    contatosDoCliente++;
                }
            }
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (opcaoPrincipal == 1) {
                ...
                cadastroCliente = carregarClientesCSV();
                cadastroContato = carregarContatosCSV();
            }
        } while (opcaoPrincipal != 0);
    }

    public static String[][] carregarClientesCSV() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(arquivo))) {
            ...
            while ((linha = br.readLine()) != null) {
                ...
                if (dados.length >= 8) {
                    ...
                    matrizClientes[indice][0] = dados[0].trim();
                    matrizClientes[indice][1] = dados[1].trim();
                    matrizClientes[indice][2] = dados[2].trim();
                    matrizClientes[indice][3] = dados[3].trim();
                    matrizClientes[indice][4] = dados[4].trim();
                    matrizClientes[indice][5] = dados[5].trim();
                    matrizClientes[indice][6] = dados[6].trim();
                    matrizClientes[indice][7] = dados[7].trim().toUpperCase();
                }
            }
    ...
    public static String[][] carregarContatosCSV() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(arquivo))) {
            ...
            while ((linha = br.readLine()) != null) {
                ...
                if (dados.length >= 5) {
                    ...
                    matrizContatos[indice][0] = dados[0].trim();
                    matrizContatos[indice][1] = dados[1].trim();
                    matrizContatos[indice][2] = dados[2].trim();
                    matrizContatos[indice][3] = dados[3].trim();
                    matrizContatos[indice][4] = dados[4].trim().toUpperCase();
                }
            }
            System.out.println("Contatos carregados com sucesso!");

        } catch (IOException e) {
            System.out.println("Erro ao ler contatos.csv: " + e.getMessage());
        }
